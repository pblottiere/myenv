...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MAIN] = LAYOUT_ortho_4x12(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  KC_SPC,  KC_SPC,  KC_DOT,  KC_LEFT, KC_DOWN, KC_RGHT
  ),
 ...
 _______, KC_AMPR, KC_TILD, KC_HASH, KC_LBRC, KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, _______,
